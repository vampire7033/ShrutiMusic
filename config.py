...
BOT_USERNAME = os.getenv("BOT_USERNAME", "vampire_x_musicbot")
...
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/vampire_x_musicbot")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/vampire_x_musicbot")
